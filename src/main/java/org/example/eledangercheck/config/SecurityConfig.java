...
import org.example.eledangercheck.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/disclosures/**", "/api/tasks/**", "/api/hazards/**", "/api/safety-measures/**", "/api/accident-cases/**", "/api/dict/**", "/api/tts/**").permitAll()
